...
contract Box is Initializable, ERC721AUpgradeable, OwnableUpgradeable{
    ...
    // initialize insted of constructor for upgradable contract
    ...
    // This function is also working now
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseTokenUri).length > 0 ? string(abi.encodePacked(abi.encodePacked(baseTokenUri, trueId.toString()),".json")) : "";
    }
